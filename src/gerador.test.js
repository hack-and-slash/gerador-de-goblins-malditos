...
describe('Testes das funções geradoras', () => {
  ...
  it('calcularAtributoDeCombate deve retornar um número', (done) => {
    ...
    expect(typeof calcularAtributoDeCombate(coloracao, ocupacao)).toBe('number');
    done();
  });
  ...
  it('calcularAtributoDeConhecimento deve retornar um número', (done) => {
    ...
    expect(typeof calcularAtributoDeConhecimento(coloracao, ocupacao)).toBe('number');
    done();
  });
  ...
  it('calcularAtributoDeHabilidade deve retornar um número', (done) => {
    ...
    expect(typeof calcularAtributoDeHabilidade(coloracao, ocupacao)).toBe('number');
    done();
  });
